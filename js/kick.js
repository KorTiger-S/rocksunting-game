...
const TRIP_REACT={
 ...
 주멘:['컨디션 매우나쁨은 계획에 없었는데…','변수 발생. 다음엔 에너지드링크부터 마시자.'],
...
const CHAT={
 ...
 ㅈㄱ:['…어제 희귀 포켓몬 카드를 뽑았어.','…피카츄가 제일 좋아.','…(말없이 이상해씨 카드를 내민다)','…오늘 급식은 고라파덕 색이었어.','…포켓몬 배지, 다음 달에 다 모아.','…(조용히 카드 뒷면을 확인한다)','…이 승부, 체육관 관장전 같아.','…파이리를 좋아하지만 티는 안 내.','…(말없이 고개만 끄덕인다)','…오늘따라 잠만보처럼 졸려.'],
